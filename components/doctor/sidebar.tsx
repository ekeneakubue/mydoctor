            ...
            >
                <div className="h-screen flex flex-col" suppressHydrationWarning>
                    <div className="h-20 border-b border-slate-200 px-5 py-4" suppressHydrationWarning>
                        <p className="text-xs font-bold uppercase tracking-[0.16em] text-blue-700">MyDoctor</p>
                        <h1 className="mt-1 text-xl font-black text-slate-900">Doctor Workspace</h1>
                    </div>
